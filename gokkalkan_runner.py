...
class GokkalkanRunner:
    """GökKalkan CLI Simulation Runner - Unified Engine Client"""
    def __init__(self):
        self.engine = GokkalkanEngine()
        self.console = console

    def create_table(self, targets: list, ammo: int) -> Table:
        table = Table(title="[bold magenta]GÖKKALKAN CLI RUNNER — TAKTİK VERİ[/]")
    ...
    def run(self):
        ...
        self.console.print("[dim]Bu istemci merkezi GokkalkanEngine çekirdeğini kullanmaktadır.[/]")
